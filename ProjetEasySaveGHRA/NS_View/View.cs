        ...
        public void ConsoleUpdate(int _id)
        {
            ...
            else if (_id < 200 && language == "FR")
            {
                ...
                switch (_id)
                {
                    ...
                    case 100:
                        Console.WriteLine("\n----- BIENVENUE SUR HARG EASYSAVE -----");
                        ConsoleUpdate(1);
                        break;

                    case 101:
                        Console.WriteLine("\nLa sauvegarde été correctement ajouter !");
                        ConsoleUpdate(1);
                        break;

                    case 102:
                        Console.WriteLine("\nLe sauvegarde a été correctement sauvegarder !");
                        break;

                    case 103:
                        Console.WriteLine("\nLe sauvegarde a été correctement supprimer !");
                        ConsoleUpdate(1);
                        break;
            ...
            else if (_id < 200)
            {
                ...
                switch (_id)
                {
                    // Success message from 100 to 199
                    case 100:
                        Console.WriteLine("\n----- WELCOME TO HARG EASYSAVE -----");
                        ConsoleUpdate(1);
                        break;

                    case 101:
                        Console.WriteLine("\nThe backup was added with success!");
                        ConsoleUpdate(1);
                        break;

                    case 102:
                        Console.WriteLine("\nThe backup was saved with success!");
                        break;

                    case 103:
                        Console.WriteLine("\nThe backup was removed with success!");
                        ConsoleUpdate(1);
                        break;
            ...
            else if (_id < 300 && language == "FR")
            {
                ...
                switch (_id)
                {
                    ...
                    case 201:
                        Console.WriteLine("\nEchec de l'ajout d'un sauvegarde.");
                        ConsoleUpdate(1);
                        break;

                    case 202:
                        Console.WriteLine("\nEchec de la sauvegarde du sauvegarde.");
                        ConsoleUpdate(1);
                        break;

                    case 203:
                        Console.WriteLine("\nEchec de la suppression d'un sauvegarde.");
                        ConsoleUpdate(1);
                        break;

                    case 204:
                        Console.WriteLine("\nLa liste de sauvegarde est vide.");
                        ConsoleUpdate(1);
                        break;

                    case 205:
                        Console.WriteLine("\nLa liste de sauvegarde est pleine.");
                        ConsoleUpdate(1);
                        break;
                    ...
                    case 214:
                        Console.WriteLine("\nLe nom du sauvegarde est déjà utilisé. Veuillez en choisir un autre :");
                        break;
            ...
            else if (_id < 300)
            {
                ...
                switch (_id)
                {
                    ...
                    case 202:
                        Console.WriteLine("\nFailed to saved backup.");
                        ConsoleUpdate(1);
                        break;

                    case 203:
                        Console.WriteLine("\nFailed to removed backup.");
                        ConsoleUpdate(1);
                        break;
                    ...
                    case 214:
                        Console.WriteLine("\nBackupName already taken. Please enter an other name.");
                        break;
            ...
            else if (language == "FR")
            {
                switch (_id)
                {
                    ...
                    case 301:
                        Console.WriteLine("Paramètres pour ajouter un sauvegarde :");
                        break;
                    ...
                    case 306:
                        Console.WriteLine(
                            "Choisir un sauvegarde à sauvegarder : " +
                            "\n\n1 - Tous");
                        break;

                    case 307:
                        Console.WriteLine("Liste de sauvegarde :");
                        break;

                    case 308:
                        Console.WriteLine("Choisir un sauvegarde à supprimer :");
                        break;
            ...
            else //if(language == "EN")
            {
                switch (_id)
                {
                    ...
                    case 301:
                        Console.WriteLine("Parameter to add a backup:");
                        break;
                    ...
                    case 308:
                        Console.WriteLine("Choose the backup to remove :");
                        break;
